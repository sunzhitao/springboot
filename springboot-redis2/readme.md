文档详见：https://blog.csdn.net/sunzhitao1990/article/details/80648243
...
还有
redis.clients
不引入 redis.clients的情况下JedisPoolConfig的引入会出现问题（个人测试得出的结论）

**第二步：配置**

首先 创建一个redis的配置文件 redis.properties
